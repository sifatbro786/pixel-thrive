            ...
            <Link
                ...
                className={`${
                    from === "mobile"
                        ...
                        : "py-3 px-[30px] rounded-[50px] border-1 border-secondary text-center text-secondary text-2xl"
                } font-semibold leading-tight  hover:bg-secondary hover:text-primary duration-400`}
            >
                Get Started
            </Link>
        </div>
