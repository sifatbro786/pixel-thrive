...
export const AnimatedTeams = ({ testimonials, autoplay = false }) => {
    ...
    // Generate fixed random rotations on mount
        ...
        <div className="mx-auto px-3 md:px-0 mt-10 md:mt-[100px] font-sans antialiased md:max-w-7xl">
            <div className="relative grid grid-cols-1 gap-8 md:gap-20 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-between py-4">
                    ...
                    >
                        <h3 className="text-2xl font-bold text-tertiary dark:text-white">
                    ...
                    <div className="flex gap-4 mt-0 justify-center md:justify-start">
                        <button
                            onClick={handlePrev}
