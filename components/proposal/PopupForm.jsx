...
export default function PopupForm({ closePopup }) {
    return (
        <section className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-tertiary rounded-lg px-5 py-10 md:p-8 shadow-2xl w-full max-w-lg z-10 relative">
                <button
                    onClick={closePopup}
                ...
                <form className="space-y-6">
                    <div>
                        ...
                        <Input
                            ...
                            className="w-full text-sm md:text-base text-primary p-3 md:p-5 border border-gray-400 rounded-md focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            className="w-full text-sm md:text-base p-3 md:p-5 border text-primary border-gray-400 rounded-md focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        />
                    </div>
